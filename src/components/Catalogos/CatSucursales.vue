...
const headers = [
    ...
    { text: "Prefijo", value: "prefijo", sortable: true },
    { text: "Consecutivo (Cotiz.)", value: "consecutivoCotizacion", sortable: true },
    { text: "Consecutivo (O.T.)", value: "consecutivoOrdenTrabajo", sortable: true },
...
const cargarSucursales = async () => {
	loading.value = true;
	try {
		const res = await fetch(`${proxy.$serverIP}api/Sucursales/getSucursales?activas=false`);
