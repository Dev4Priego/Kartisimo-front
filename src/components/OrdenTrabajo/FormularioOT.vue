...
function validate(path) {
  ...
  const rules = {
    ...
    insumos: () =>
      ordenTrabajoForm.insumo.adicional.length == 0 &&
      ordenTrabajoForm.insumo.llanta.length == 0 &&
      ordenTrabajoForm.insumo.paquete.length == 0
        ? "Debe incluir por lo menos un insumo."
        : null,
  };
