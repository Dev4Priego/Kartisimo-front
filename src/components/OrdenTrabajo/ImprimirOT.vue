  ...
  <div v-if="modelValue">
    <div id="area-print">
      ...
      >
          ...
          >
            <div class="w-100">
              <h5 class="fw-bold mb-1">
                Orden de Trabajo O{{ props.OT?.prefijoSucursal }}-{{
                  props.OT?.consecutivoSucursal
                }}
              </h5>
              <div class="row">
                <div class="col-7">
              ...
              <div class="mt-1">
                ...
                <strong>{{ formatearFecha(props.OT?.fechaEntrega) }}</strong>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-6">
                ...
                <div class="">
                  ...
                  {{ props.OT?.vehiculo?.marca }}
                  {{ props.OT?.vehiculo?.modelo }}
                  {{ props.OT?.vehiculo?.color }}
                </div>
        ...
        <!-- FACTURA -->
        <div
          v-if="props.OT?.requiereFactura"
          class="card border-1 shadow-sm mb-2"
        >
          <div class="card-body">
            <h5 class="fw-bold mb-3">
...
const tieneLlantas = computed(() => props.OT?.insumo?.llantas?.length > 0);

const tienePaquetes = computed(() => props.OT?.insumo?.paquetes?.length > 0);
