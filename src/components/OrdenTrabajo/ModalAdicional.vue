<template>
  ...
  <div class="row my-3 mx-3">
    <div class="d-flex gap-3 my-3">
      ...
      <button
        class="btn btn-primary position-relative align-self-end shadow"
        style="width: 130px"
        @click="agregarFila"
      >
...
// "PRE-CARGAR" El nombre del concepto de trabajo 
const cargarNombreConcepto = () => {
  const conceptoSeleccionado = props.conceptoOT.find(
    (concepto) =>
      Number(concepto.idConceptoOrdenTrabajo) === Number(Concepto.value),
  );

  Servicio.value = conceptoSeleccionado?.nombre || "";
};
